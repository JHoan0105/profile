  ...
  let stylesColorMode = useColorModeValue(
    {
      ...
      pathColor: percentage >= 50 ? "var(--chakra-colors-red-500)" : "var(--chakra-colors-brand-500)",
      trailColor: '#E9EDF7',
    ...
    },
    {
      ...
      textSize: '0px',
      pathTransitionDuration: 0.5,
      pathColor: percentage >= 50 ? "var(--chakra-colors-red-600)" : "var(--chakra-colors-brand-500))",
      textColor: 'transparent',
      trailColor: '#1B254B',
    }
  );
