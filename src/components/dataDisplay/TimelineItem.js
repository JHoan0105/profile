...
export default function Default(props) {
  ...
  const miniCardNonCurrent = useColorModeValue('transparent', 'guardianDark.100');
  const boxCurrent = useColorModeValue('brand.600', 'guardianDark.500');
  const boxNonCurrent = useColorModeValue('secondaryGray.300', 'guardianDark.200');
