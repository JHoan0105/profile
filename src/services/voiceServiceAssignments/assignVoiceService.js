...
// Default function
export default async function assignVoiceService(templateID, isGlobal, accountNumber) {
  console.log("assign voice service");
  ...
  try {
    const verify = await axios.post(`${process.env.REACT_APP_PROVISIONING_PORTAL_API_URL}/provisioning/certus/templates/voice/${templateID}/assign`,
      requestBody,
      {
