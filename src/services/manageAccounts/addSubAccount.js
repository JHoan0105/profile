...
// Default function 
export default async function addSubAccount(number, name, email, accountnum, accountname) {
  ...
  try {
    ...
    const verify = await axios.post(`${process.env.REACT_APP_PROVISIONING_PORTAL_API_URL}/addOrganizationSubAccount`,
      {
        number: number,
        name: name,
        email: email,
