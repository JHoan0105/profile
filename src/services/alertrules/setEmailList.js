...
// Default function
export default async function setEmailList(accountNumber, recipients) {
  ...
  try {
    const verify = await axios.put(`${process.env.REACT_APP_PROVISIONING_PORTAL_API_URL}/flexbill/account/${accountNumber}/alert/group`,
      {
        "accountNumber": accountNumber,
        "recipients": recipients,
        "enabled": true
