...
// Default function
function AccountUsersTable(props) {
  ...
  useEffect(() => {
    setPageSize(Number(filters?.list?.manageaccountusers || 10))
  }, [filters])
      ...
      <Flex
        ...
        >
          <SearchBar
            ...
            h='44px'
            w={{ lg: "250px" }}
            ml={{ base: "5px", lg: "15px", xl: "20px" }} // Adjusting margin-left for larger screens
            borderRadius='16px'
          />
        </Flex>
                ...
                {headerGroup.headers.map((column, index) => (
                  <Th
                    ...
                    <Flex
                      ...
                      align='center'
                      justifyContent={column.Header==='ACTION'?'center':'flex'}
              ...
              return (
                <Tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    let data = "";
                    if (cell.column.Header === "ACCOUNT USERS") {
                      data = (
                        <Text
                          fontSize='sm'
                          fontWeight='500'
          ...
          <Flex align='center'>
            <Select
              ...
              onChange={(e) => {
                ...
                localStorage.setItem('filters', jsonToString(({ ...filters, list: { ...filters?.list, manageaccountusers: e.target.value } })));
              }
              }>
