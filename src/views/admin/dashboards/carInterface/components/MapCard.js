...
const MAPBOX_TOKEN =
  "pk.eyJ1Ijoic2ltbW1wbGUiLCJhIjoiY2wxeG1hd24xMDEzYzNrbWs5emFkdm16ZiJ9.q9s0sSKQFFaT9fyrC-7--g"; // Set your mapbox token here
...
export default function YourTransfers(props) {
  ...
  const inputBg = useColorModeValue(
    ...
    { base: "guardianDark.100", md: "guardianDark.500" }
  );
  ...
  const handleZoomIn = () => {
    ...
    setViewState((prevState) => ({
      ...prevState,
      zoom: Math.min(prevState.zoom + 1, 22),
    }));
  };
  ...
  const handleZoomOut = () => {
    ...
    setViewState((prevState) => ({
      ...prevState,
      zoom: Math.max(prevState.zoom - 1, 0),
    }));
  };
