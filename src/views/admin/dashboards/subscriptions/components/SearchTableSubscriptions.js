              ...
              return (
                <Tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    let data = "";
                    ...
                    } else if (cell.column.Header === "SIM") {
                      data = (
                        <Text color={textColor} fontSize='md' fontWeight='500'>
                          {cell.value}
                        </Text>
                      ...
                      } else if (cell.column.Header === "ACTIVATED") {
                      data = (
                        <Text color={textColor} fontSize='md' fontWeight='500'>
                          {cell.value}
                        </Text>
                          ...
                          var statusActive = "IN PROGRESS"
                          if (cell.row.original.active === "true") {
                              statusColor = "green";
                              statusActive = "ACTIVATED"
                          }
                          else if (cell.row.original.datedeactivated !== "") {
                              statusColor = "red";
