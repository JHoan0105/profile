...
export default function CircularProgress() {
  ...
  const cardBg = useColorModeValue('white', 'guardianDark.100');
  ...
  return (
    <Card p="30px">
      ...
      <IconBox
        ...
        bg={cardBg}
        icon={
          <Icon as={MdOutlineLightbulb} color={iconColor} h="56px" w="56px" />
        }
      />
      <Box mb="36px">
        <Text
      ...
      <RangeSlider colorScheme="brand" defaultValue={[10, 30]}>
