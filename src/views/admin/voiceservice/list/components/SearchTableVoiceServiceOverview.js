...
// Default function
function VoiceServiceTable(props) {
  ...
  useEffect(() => {
    setPageSize(Number(filters?.list?.voiceservice || 10))
  }, [filters])
        ...
        >
          ...
          {(accountInfo?.isGuardianAdmin) ? (
            <Button
              ...
              _focus={{ bg: "brand.500" }}
              onClick={() => nav(PATH_NAME.VOICE_SERVICE)}
            >
                  ...
                  {row.cells.map((cell, index) => {
                    ...
                    if (cell.column.Header === "NAME") {
                      ...
                      data = (
                        <Text
                          as={Link}
                          to={`${PATH_NAME.VOICE_SERVICE}?id=${cell.value}`}
                          cursor='pointer'
                          color={brandColor}
          ...
          <Flex align='center'>
            <Select
              ...
              onChange={(e) => {
                ...
                localStorage.setItem('filters', jsonToString(({ ...filters, list: { ...filters?.list, voiceservice: e.target.value } })));
              }}>
...
export default VoiceServiceTable;
